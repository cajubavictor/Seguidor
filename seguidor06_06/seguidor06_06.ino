...
#define VBASE_CURVA               50
#define VBASE_RETA                60
...
char VETOR_FILA[TAMANHO_FILA] = {'F','I','X','X','F','T', 'I', 'F', 'I', 'X', 'X','F', 'T', 'I', 'X', 'X', 'F', 'I', 'F'};
...
void controleCurva() {
  ...
  if (correcao == 0) {
    ...
    velocidadeMotorDireito = -abs(correcao - base) + correcao;
    ...
    velocidadeMotorEsquerdo = -abs(correcao + base) - correcao;
    if (velocidadeMotorDireito > VELOCIDADE_MAXIMA)
      velocidadeMotorDireito = VELOCIDADE_MAXIMA;
